...
#[link(name = "action_interfaces__rosidl_typesupport_c")]
extern "C" {
    fn rosidl_typesupport_c__get_action_type_support_handle__action_interfaces__action__MoveArm() -> *const std::ffi::c_void;
}

// Corresponds to action_interfaces__action__MoveArm
#[allow(missing_docs, non_camel_case_types)]
pub struct MoveArm;
...
impl rosidl_runtime_rs::Action for MoveArm {
  ...
  fn get_type_support() -> *const std::ffi::c_void {
    // SAFETY: No preconditions for this function.
    unsafe { rosidl_typesupport_c__get_action_type_support_handle__action_interfaces__action__MoveArm() }
  }
