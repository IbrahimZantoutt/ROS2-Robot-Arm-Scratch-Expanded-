...
public:
  ...
  : msg_(msg)
  {}
  Init_CheckLimits_Request_wrist_angle elbow_angle(::action_interfaces::srv::CheckLimits_Request::_elbow_angle_type arg)
  {
    msg_.elbow_angle = std::move(arg);
    return Init_CheckLimits_Request_wrist_angle(msg_);
  }
