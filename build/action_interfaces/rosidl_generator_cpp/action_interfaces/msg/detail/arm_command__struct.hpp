...
struct ArmCommand_
{
  ...
  using _spin_angle_cmd_type =
    float;
  _spin_angle_cmd_type spin_angle_cmd;
  ...
  Type & set__spin_angle_cmd(
    const float & _arg)
  {
    this->spin_angle_cmd = _arg;
    return *this;
  }
  ...
  bool operator==(const ArmCommand_ & other) const
  {
    ...
    if (this->spin_angle_cmd != other.spin_angle_cmd) {
      return false;
    }
    return true;
  }
