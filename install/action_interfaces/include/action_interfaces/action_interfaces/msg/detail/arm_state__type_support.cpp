...
{
  new (message_memory) action_interfaces::msg::ArmState(_init);
}

void ArmState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<action_interfaces::msg::ArmState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ArmState_message_member_array[4] = {
  {
    ...
    offsetof(action_interfaces::msg::ArmState, shoulder_angle),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(action_interfaces::msg::ArmState, elbow_angle),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(action_interfaces::msg::ArmState, spin_angle),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<action_interfaces::msg::ArmState>()
{
  return &::action_interfaces::msg::rosidl_typesupport_introspection_cpp::ArmState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, action_interfaces, msg, ArmState)() {
  return &::action_interfaces::msg::rosidl_typesupport_introspection_cpp::ArmState_message_type_support_handle;
}
