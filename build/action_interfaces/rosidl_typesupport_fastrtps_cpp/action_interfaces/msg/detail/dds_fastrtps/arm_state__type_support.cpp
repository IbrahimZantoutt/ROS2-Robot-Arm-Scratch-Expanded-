...
#include "action_interfaces/msg/detail/arm_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const action_interfaces::msg::ArmState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  action_interfaces::msg::ArmState & ros_message)
{
  // Member: shoulder_angle
  cdr >> ros_message.shoulder_angle;
...
{
  auto typed_message =
    static_cast<const action_interfaces::msg::ArmState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<action_interfaces::msg::ArmState *>(
    untyped_ros_message);
...
{
  return &action_interfaces::msg::typesupport_fastrtps_cpp::_ArmState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, action_interfaces, msg, ArmState)() {
  return &action_interfaces::msg::typesupport_fastrtps_cpp::_ArmState__handle;
}
