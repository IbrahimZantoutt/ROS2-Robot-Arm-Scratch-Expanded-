...
class MoveArm_Goal(metaclass=Metaclass_MoveArm_Goal):
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.shoulder_angle_goal != other.shoulder_angle_goal:
            return False
    ...
    @builtins.property
    def shoulder_angle_goal(self):
        """Message field 'shoulder_angle_goal'."""
        return self._shoulder_angle_goal

    @shoulder_angle_goal.setter
    def shoulder_angle_goal(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'shoulder_angle_goal' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'shoulder_angle_goal' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._shoulder_angle_goal = value

    @builtins.property
    def elbow_angle_goal(self):
        """Message field 'elbow_angle_goal'."""
        return self._elbow_angle_goal

    @elbow_angle_goal.setter
    def elbow_angle_goal(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'elbow_angle_goal' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'elbow_angle_goal' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._elbow_angle_goal = value

    @builtins.property
    def wrist_angle_goal(self):
        """Message field 'wrist_angle_goal'."""
        return self._wrist_angle_goal

    @wrist_angle_goal.setter
    def wrist_angle_goal(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'wrist_angle_goal' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
