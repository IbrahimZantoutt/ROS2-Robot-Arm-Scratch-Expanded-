...
#include "action_interfaces/action/detail/move_arm__rosidl_typesupport_fastrtps_c.h"
...
using _MoveArm_Goal__ros_msg_type = action_interfaces__action__MoveArm_Goal;
...
size_t get_serialized_size_action_interfaces__action__MoveArm_Goal(
  const void * untyped_ros_message,
...
static uint32_t _MoveArm_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_action_interfaces__action__MoveArm_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t max_serialized_size_action_interfaces__action__MoveArm_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _MoveArm_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_action_interfaces__action__MoveArm_Goal(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, MoveArm_Goal)() {
...
using _MoveArm_Result__ros_msg_type = action_interfaces__action__MoveArm_Result;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: shoulder_angle_rs
  {
    cdr << ros_message->shoulder_angle_rs;
  }

  // Field name: elbow_angle_rs
  {
    cdr << ros_message->elbow_angle_rs;
  }

  // Field name: wrist_angle_rs
  {
    cdr << ros_message->wrist_angle_rs;
  }

  // Field name: spin_angle_rs
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t get_serialized_size_action_interfaces__action__MoveArm_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MoveArm_Result__ros_msg_type * ros_message = static_cast<const _MoveArm_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_action_interfaces__action__MoveArm_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t max_serialized_size_action_interfaces__action__MoveArm_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = action_interfaces__action__MoveArm_Result;
    is_plain =
      (
...
static size_t _MoveArm_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_action_interfaces__action__MoveArm_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, MoveArm_Result)() {
...
using _MoveArm_Feedback__ros_msg_type = action_interfaces__action__MoveArm_Feedback;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: shoulder_angle_fb
  {
    cdr << ros_message->shoulder_angle_fb;
  }

  // Field name: elbow_angle_fb
  {
    cdr << ros_message->elbow_angle_fb;
  }

  // Field name: wrist_angle_fb
  {
    cdr << ros_message->wrist_angle_fb;
  }

  // Field name: spin_angle_fb
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t get_serialized_size_action_interfaces__action__MoveArm_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MoveArm_Feedback__ros_msg_type * ros_message = static_cast<const _MoveArm_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_action_interfaces__action__MoveArm_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t max_serialized_size_action_interfaces__action__MoveArm_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = action_interfaces__action__MoveArm_Feedback;
    is_plain =
      (
...
static size_t _MoveArm_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_action_interfaces__action__MoveArm_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, MoveArm_Feedback)() {
...
// already included above
// #include "action_interfaces/action/detail/move_arm__functions.h"  // goal
...
using _MoveArm_SendGoal_Request__ros_msg_type = action_interfaces__action__MoveArm_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, action_interfaces, action, MoveArm_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t get_serialized_size_action_interfaces__action__MoveArm_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MoveArm_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _MoveArm_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_action_interfaces__action__MoveArm_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_action_interfaces__action__MoveArm_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t max_serialized_size_action_interfaces__action__MoveArm_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_action_interfaces__action__MoveArm_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = action_interfaces__action__MoveArm_SendGoal_Request;
    is_plain =
      (
...
static size_t _MoveArm_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_action_interfaces__action__MoveArm_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, MoveArm_SendGoal_Request)() {
...
using _MoveArm_SendGoal_Response__ros_msg_type = action_interfaces__action__MoveArm_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t get_serialized_size_action_interfaces__action__MoveArm_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MoveArm_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _MoveArm_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_action_interfaces__action__MoveArm_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t max_serialized_size_action_interfaces__action__MoveArm_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = action_interfaces__action__MoveArm_SendGoal_Response;
    is_plain =
      (
...
static size_t _MoveArm_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_action_interfaces__action__MoveArm_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, MoveArm_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, MoveArm_SendGoal)() {
...
using _MoveArm_GetResult_Request__ros_msg_type = action_interfaces__action__MoveArm_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t get_serialized_size_action_interfaces__action__MoveArm_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MoveArm_GetResult_Request__ros_msg_type * ros_message = static_cast<const _MoveArm_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_action_interfaces__action__MoveArm_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t max_serialized_size_action_interfaces__action__MoveArm_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = action_interfaces__action__MoveArm_GetResult_Request;
    is_plain =
      (
...
static size_t _MoveArm_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_action_interfaces__action__MoveArm_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, MoveArm_GetResult_Request)() {
...
// already included above
// #include "action_interfaces/action/detail/move_arm__functions.h"  // result
...
using _MoveArm_GetResult_Response__ros_msg_type = action_interfaces__action__MoveArm_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, action_interfaces, action, MoveArm_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t get_serialized_size_action_interfaces__action__MoveArm_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MoveArm_GetResult_Response__ros_msg_type * ros_message = static_cast<const _MoveArm_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_action_interfaces__action__MoveArm_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_action_interfaces__action__MoveArm_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t max_serialized_size_action_interfaces__action__MoveArm_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_action_interfaces__action__MoveArm_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = action_interfaces__action__MoveArm_GetResult_Response;
    is_plain =
      (
...
static size_t _MoveArm_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_action_interfaces__action__MoveArm_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, MoveArm_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, MoveArm_GetResult)() {
...
// already included above
// #include "action_interfaces/action/detail/move_arm__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _MoveArm_FeedbackMessage__ros_msg_type = action_interfaces__action__MoveArm_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, action_interfaces, action, MoveArm_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t get_serialized_size_action_interfaces__action__MoveArm_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MoveArm_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _MoveArm_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_action_interfaces__action__MoveArm_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_action_interfaces__action__MoveArm_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t max_serialized_size_action_interfaces__action__MoveArm_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_action_interfaces__action__MoveArm_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = action_interfaces__action__MoveArm_FeedbackMessage;
    is_plain =
      (
...
static size_t _MoveArm_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_action_interfaces__action__MoveArm_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, MoveArm_FeedbackMessage)() {
